   ...
   //======================================================================================================
   // It is little code to demonstrate polling in microcontroller and particularly in UART.
   // Polling is not the best approach to read from FIFOs because it takes up useful processing
   // time. Other efficient approach like interrupt can be used.  This code is only for demonstration
   // purposes.
